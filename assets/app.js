...
async function saveGroup(
  ...
  if (isSolution) {
    ...
    groupName =
      `${gradeArabic(grade)} - ${dayArabic(day1)} والثاني - ${formatTime(startTime)}`;
  ...
  // ================================================
  // التأكد من عدم وجود نفس المجموعة
  // ================================================
